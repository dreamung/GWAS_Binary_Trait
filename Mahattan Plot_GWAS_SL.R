...
manhattan(assoc, col=c("green4", "red"), suggestiveline=F, genomewideline=F)
dev.off()

library(png)
img <- readPNG("Manhattan_Plot_for_binary_r_met.png")
grid::grid.raster(img)

img <- readPNG("Manhattan_Plot_for_binary_s_met.png")
grid::grid.raster(img)

img <- readPNG("Manhattan_Plot_for_binary_r_eddp.png")
grid::grid.raster(img)

img <- readPNG("Manhattan_Plot_for_binary_s_eddp.png")
grid::grid.raster(img)